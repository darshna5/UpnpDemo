...
public class AndroidUpnpProvider {
    ...
    public ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            System.out.println("AndroidUpnpProvider.onServiceConnected ==="+upnpService.getRegistry().getDevices());
...
//        System.out.println("AndroidUpnpProvider.getDevices="+registryListener.returnDevices().toString());
        return registryListener.returnDevices().toString();
    }

    public JSONArray getDevices1() {
//        System.out.println("AndroidUpnpProvider.getDevices="+registryListener.returnDevices().toString());
        return registryListener.returnDevices();
    }
    ...
    public UpnpServiceConfiguration getAddress(){
